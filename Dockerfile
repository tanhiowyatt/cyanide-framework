...
COPY src/ src/
RUN pip install --no-cache-dir .[outputs,libvirt]
...
RUN mkdir -p var/log/cyanide/sessions var/log/cyanide/keys var/quarantine var/lib/cyanide \
