...
Cyanide Framework goes beyond simple logging by automatically extracting **Indicators of Compromise (IOCs)** from attacker interactions and aggregating them into standardized, actionable reports.
...
*   **File Hashes (SHA-256)**: Automatically calculated for anomalous file uploads quarantined by the framework.
...
*   **Identity Object**: Representing the framework sensor itself.
