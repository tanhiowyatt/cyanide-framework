...
This guide provides a step-by-step checklist to manually verify every feature of the Cyanide framework. Tests are ordered from **Level 1 (Basic)** to **Level 5 (Expert/Adversarial)**.

---

##  Level 1: Basic Connectivity & Emulation
*Goal: Ensure the framework is reachable and basic services respond.*
