...
## Overview
Running a production framework requires robust monitoring and forensic toolsets. Cyanide provides built-in utilities for real-time traffic visualization and replaying attacker session data exactly as it was typed.
