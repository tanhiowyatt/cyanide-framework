...
This module forms the brain and the operational center of the Cyanide framework. It manages the server lifecycle, handles incoming connections, orchestrates backend VMs, and maintains the isolated state of every active session.
