...
def _assemble_config_dict(config_data: dict) -> dict:
    ...
    return {
        "hostname": get_val("framework", "hostname", "server01"),
        ...
        "quarantine_path": get_val("framework", "quarantine_path", "var/quarantine"),
        ...
        "package_managers": (
            get_val("framework", "package_manager", "").split(",")
            if get_val("framework", "package_manager", "")
            else []
        ),
        ...
        "quarantine_max_size_mb": get_val("framework", "quarantine_max_size_mb", 500, int),
        "dns_cache_ttl": get_val("framework", "dns_cache_ttl", 60, int),
        "allow_local_network": get_val("framework", "allow_local_network", False, bool),
        "fs_yaml": get_val("framework", "fs_yaml", None),
        "ssh": {
        ...
        "session_pool": {
            "enabled": get_val("session_pool", "enabled", True, bool),
            "max_size": get_val("session_pool", "max_size", 20, int),
            "profiles": get_val("session_pool", "profiles", ["debian", "rhel"], cast="json"),
        },
        "output": config_data.get("output", {}),
        "custom_profile": config_data.get("custom_profile", {}),
        "honeytokens": get_val("framework", "honeytokens", [], cast="json"),
        "users": get_val(
            "auth",
            "users",
