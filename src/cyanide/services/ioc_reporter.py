...
class IOCReporter:
    ...
    def generate_stix_report(self, quiet: bool = False) -> Optional[str]:
        ...
        framework_identity = {
            ...
            "name": self.config.get("framework", {}).get("hostname", "Cyanide-Framework"),
            "description": "Cyanide Framework Sensor",
            "identity_class": "system",
            "created": datetime.now(timezone.utc).isoformat(),
            "modified": datetime.now(timezone.utc).isoformat(),
        }
        objects.append(framework_identity)
        ...
        for ioc in self.iocs:
            ...
            indicator = {
                ...
                "created_by_ref": framework_identity["id"],
            }
    ...
    def generate_misp_report(self, quiet: bool = False) -> Optional[str]:
        ...
        event: Dict[str, Any] = {
            "Event": {
                "uuid": str(uuid.uuid4()),
                "info": f"Cyanide Framework IOC Report - {datetime.now().date()}",
