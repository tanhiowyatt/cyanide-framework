...
Intercepts traffic between an attacker and a backend framework (or simulated backend),
...
class CyanideSSHClientConnection(asyncssh.SSHClientConnection):
    ...
    Manages the SSH connection between the proxy and the backend framework/server.
    """
