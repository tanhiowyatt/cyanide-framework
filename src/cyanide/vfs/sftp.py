...
class CyanideSFTPHandler(asyncssh.SFTPServer):
    """
    SFTP server implementation for Cyanide framework.
    ...
    async def close(self, handle: Any):
        ...
        if fh["is_write"]:
            ...
            # Save to Quarantine
            self.framework.save_quarantine_file(
