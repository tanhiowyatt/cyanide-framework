...
class SuCommand(Command):
    ...
    def _validate_password(self, password: str) -> bool:
        """Check password against config, fallbacks, and framework defaults."""
    ...
    def _update_emulator_state(self):
        ...
        home = self.emulator.get_home_dir(self.target_user)
        if self.login_shell or (self.target_user == "root" and self.emulator.cwd == "/"):
