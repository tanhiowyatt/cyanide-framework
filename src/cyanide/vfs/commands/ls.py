...
class LsCommand(Command):
    ...
    def _format_recursive(
        ...
        while queue:
            ...
            self._queue_children(curr_path, curr_node, show_all, queue)

        return output, "", 0

    def _queue_children(self, curr_path: str, curr_node: Directory, show_all: bool, queue: list):
        """Helper to queue children directories for recursion."""
