...
## Framework Safety & Risks

Running a framework inherently involves exposure to malicious actors. While Cyanide is designed with strong isolation mechanisms (such as the VFS layer and Dockerization), users should be aware of the following:
...
3.  **Data Exposure**: Do not place real credentials or sensitive production data inside the framework's virtual filesystem (OS Profiles).
